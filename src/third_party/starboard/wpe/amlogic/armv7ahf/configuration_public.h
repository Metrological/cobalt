...
#ifndef THIRD_PARTY_STARBOARD_WPE_AMLOGIC_ARMV7AHF_CONFIGURATION_PUBLIC_H_
#define THIRD_PARTY_STARBOARD_WPE_AMLOGIC_ARMV7AHF_CONFIGURATION_PUBLIC_H_
...
#define SB_PLATFORM_OPERATOR_NAME "Skyworth"
