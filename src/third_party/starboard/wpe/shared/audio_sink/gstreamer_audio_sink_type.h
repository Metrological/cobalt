...
#ifndef THIRD_PARTY_STARBOARD_WPE_SHARED_AUDIO_SINK_GSTREAMER_AUDIO_SINK_TYPE_H_
#define THIRD_PARTY_STARBOARD_WPE_SHARED_AUDIO_SINK_GSTREAMER_AUDIO_SINK_TYPE_H_
...
#endif  // THIRD_PARTY_STARBOARD_WPE_SHARED_AUDIO_SINK_GSTREAMER_AUDIO_SINK_TYPE_H_
