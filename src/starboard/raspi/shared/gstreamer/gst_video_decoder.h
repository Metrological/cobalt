#ifndef STARBOARD_RASPI_SHARED_GSTREAMER_VIDEO_DECODER_H_
#define STARBOARD_RASPI_SHARED_GSTREAMER_VIDEO_DECODER_H_
...
public:
    ...
    typedef ::starboard::raspi::shared::open_max::DispmanxResourcePool DispmanxResourcePool;
...
#endif  // STARBOARD_RASPI_SHARED_GSTREAMER_VIDEO_DECODER_H_
