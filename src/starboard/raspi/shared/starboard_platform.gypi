  ...
  'targets': [
    ...
    },
    {
      ...
      'sources': [
        ...
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_video_decoder.cc',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_video_decoder.h',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_video_context.cc',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_video_context.h',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_audio_decoder.cc',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_audio_decoder.h',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_audio_context.cc',
        '<(DEPTH)/starboard/raspi/shared/gstreamer/gst_audio_context.h',
