...
#ifndef STARBOARD_WPE_RPI_CONFIGURATION_PUBLIC_H_
#define STARBOARD_WPE_RPI_CONFIGURATION_PUBLIC_H_
...
#include "starboard/wpe/shared/configuration_public.h"

#endif  // STARBOARD_WPE_RPI_CONFIGURATION_PUBLIC_H_
