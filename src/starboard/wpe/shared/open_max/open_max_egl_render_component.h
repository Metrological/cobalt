...
#ifndef STARBOARD_WPE_SHARED_OPEN_MAX_OPEN_MAX_EGL_RENDER_COMPONENT_H_
#define STARBOARD_WPE_SHARED_OPEN_MAX_OPEN_MAX_EGL_RENDER_COMPONENT_H_
...
#endif  // STARBOARD_WPE_SHARED_OPEN_MAX_OPEN_MAX_EGL_RENDER_COMPONENT_H_
