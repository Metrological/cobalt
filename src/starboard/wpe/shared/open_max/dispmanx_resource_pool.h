...
#ifndef STARBOARD_WPE_SHARED_OPEN_MAX_DISPMANX_RESOURCE_POOL_H_
#define STARBOARD_WPE_SHARED_OPEN_MAX_DISPMANX_RESOURCE_POOL_H_
...
#endif  // STARBOARD_WPE_SHARED_OPEN_MAX_DISPMANX_RESOURCE_POOL_H_
