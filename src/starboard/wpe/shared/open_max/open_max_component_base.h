...
#ifndef STARBOARD_WPE_SHARED_OPEN_MAX_OPEN_MAX_COMPONENT_BASE_H_
#define STARBOARD_WPE_SHARED_OPEN_MAX_OPEN_MAX_COMPONENT_BASE_H_
...
#endif  // STARBOARD_WPE_SHARED_OPEN_MAX_OPEN_MAX_COMPONENT_BASE_H_
