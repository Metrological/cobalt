...
#ifndef STARBOARD_WPE_SHARED_VIDEO_RENDERER_SINK_IMPL_H_
#define STARBOARD_WPE_SHARED_VIDEO_RENDERER_SINK_IMPL_H_
...
#endif  // STARBOARD_WPE_SHARED_VIDEO_RENDERER_SINK_IMPL_H_
