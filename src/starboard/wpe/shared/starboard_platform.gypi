...
# limitations under the License.
{
  'targets': [
    ...
    },
    {
      ...
      'type': 'static_library',
      'sources': [
        '<(DEPTH)/starboard/wpe/shared/atomic_public.h',
        '<(DEPTH)/starboard/wpe/shared/configuration_public.h',
        '<(DEPTH)/starboard/wpe/shared/system_get_connection_type.cc',
        '<(DEPTH)/starboard/wpe/shared/system_get_device_type.cc',
        '<(DEPTH)/starboard/wpe/shared/system_get_path.cc',
        '<(DEPTH)/starboard/wpe/shared/system_has_capability.cc',
        '<(DEPTH)/starboard/wpe/shared/application_dispmanx.cc',
        '<(DEPTH)/starboard/wpe/shared/audio_sink_is_audio_sample_type_supported.cc',
        ...
        '<(DEPTH)/starboard/wpe/shared/open_max/video_decoder.cc',
        '<(DEPTH)/starboard/wpe/shared/open_max/video_decoder.h',
        ...
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_audio_resampler.cc',
        '<(DEPTH)/starboard/wpe/shared/gstreamer/gst_audio_resampler.h',
