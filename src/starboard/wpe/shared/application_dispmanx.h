...
#ifndef STARBOARD_WPE_SHARED_APPLICATION_DISPMANX_H_
#define STARBOARD_WPE_SHARED_APPLICATION_DISPMANX_H_
...
#endif  // STARBOARD_WPE_SHARED_APPLICATION_DISPMANX_H_
