...
class CobaltWpeConfiguration(cobalt_configuration.CobaltConfiguration):
  """Starboard Raspberry Pi shared Cobalt configuration."""

  def __init__(self, platform_configuration, application_name,
               application_directory):
    super(CobaltWpeConfiguration, self).__init__(
  ...
  def GetPostIncludes(self):
    ...
    includes = super(CobaltWpeConfiguration, self).GetPostIncludes()
  ...
  def GetTestFilters(self):
    filters = super(CobaltWpeConfiguration, self).GetTestFilters()
    filters.extend([
  ...
  def GetWebPlatformTestFilters(self):
    filters = super(CobaltWpeConfiguration, self).GetWebPlatformTestFilters()
    filters += [
