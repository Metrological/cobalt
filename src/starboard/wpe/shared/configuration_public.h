...
#ifndef STARBOARD_WPE_SHARED_CONFIGURATION_PUBLIC_H_
#define STARBOARD_WPE_SHARED_CONFIGURATION_PUBLIC_H_
...
#endif  // STARBOARD_WPE_SHARED_CONFIGURATION_PUBLIC_H_
