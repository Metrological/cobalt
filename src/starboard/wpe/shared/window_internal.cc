...
#include "starboard/wpe/shared/window_internal.h"
...
using starboard::wpe::shared::DispmanxElement;
using starboard::wpe::shared::DispmanxRect;
using starboard::wpe::shared::DispmanxResource;
